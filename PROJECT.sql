...
END;
/
--Procedure to update book price
...
IS
BEGIN
    UPDATE BOOK SET PRICE = p_price WHERE bookid = p_book_id;
    COMMIT;
...
/
--USER AND GRANTS
CREATE USER CUSTOMER_USER IDENTIFIED BY Dmdduser12345 DEFAULT TABLESPACE DATA_TS QUOTA UNLIMITED ON DATA_TS ;
GRANT CONNECT TO CUSTOMER_USER;
GRANT SELECT ON ADMIN_YASH.BOOK TO CUSTOMER_USER;
GRANT SELECT ON ADMIN_YASH.AUTHOR TO CUSTOMER_USER;
GRANT SELECT ON ADMIN_YASH.BOOKAUTHOR TO CUSTOMER_USER;
GRANT SELECT ON ADMIN_YASH.PUBLISHER TO CUSTOMER_USER;
GRANT SELECT ON ADMIN_YASH.STORE TO CUSTOMER_USER;
GRANT SELECT ON ADMIN_YASH.BOOK_VIEW TO CUSTOMER_USER;
GRANT SELECT ON ADMIN_YASH.TOP_SELLING_AUTHOR TO CUSTOMER_USER;
GRANT SELECT ON ADMIN_YASH.HIGHEST_SELLING_BOOKS TO CUSTOMER_USER;
/

CREATE USER EMPLOYEE_USER IDENTIFIED BY Dmdduser12345 DEFAULT TABLESPACE DATA_TS QUOTA UNLIMITED ON DATA_TS ;
GRANT CONNECT TO EMPLOYEE_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMIN_YASH.ADDRESS TO EMPLOYEE_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMIN_YASH.AUTHOR TO EMPLOYEE_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMIN_YASH.BOOK TO EMPLOYEE_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMIN_YASH.BOOKAUTHOR TO EMPLOYEE_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMIN_YASH.CUSTOMER TO EMPLOYEE_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMIN_YASH.EMPLOYEE TO EMPLOYEE_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMIN_YASH.INVENTORY TO EMPLOYEE_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMIN_YASH.ORDERS TO EMPLOYEE_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMIN_YASH.PUBLISHER TO EMPLOYEE_USER;
GRANT SELECT ON ADMIN_YASH.STORE TO EMPLOYEE_USER;
GRANT EXECUTE ON ADMIN_YASH.BOOKMANAGEMENT TO EMPLOYEE_USER;
GRANT EXECUTE ON ADMIN_YASH.ADD_NEW_AUTHOR TO EMPLOYEE_USER;
GRANT EXECUTE ON ADMIN_YASH.ADD_NEW_BOOK TO EMPLOYEE_USER;
GRANT EXECUTE ON ADMIN_YASH.ADD_NEW_CUSTOMER TO EMPLOYEE_USER;
GRANT EXECUTE ON ADMIN_YASH.ADD_NEW_PUBLISHER TO EMPLOYEE_USER;
GRANT EXECUTE ON ADMIN_YASH.ADD_ORDER TO EMPLOYEE_USER;
GRANT EXECUTE ON ADMIN_YASH.UPDATE_BOOK_PRICE TO EMPLOYEE_USER;
GRANT EXECUTE ON ADMIN_YASH.GET_BOOK_PRICE TO EMPLOYEE_USER;
GRANT EXECUTE ON ADMIN_YASH.GET_BOOK_QUANTITY TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.BOOK_VIEW TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.AUTHOR_EVERY_GENRE TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.BOOKS_AVAILABLE TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.EMPLOYEE_COUNT TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.HIGHEST_SELLING_BOOKS TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.HIGHEST_TOTAL_SPEND TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.NUM_OF_ORDERS_EACH_STORE TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.ORDER_DETAILS TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.TOP_SELLING_AUTHOR TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.V_MOST_BOOKS_SOLD_PER_STORE TO EMPLOYEE_USER;
GRANT ALL PRIVILEGES ON ADMIN_YASH.V_STORE_SALES TO EMPLOYEE_USER;
